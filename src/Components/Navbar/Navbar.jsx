...
const Navbar = () => {
    const [messageApi, contextHolder] = message.useMessage(); //Mesajlarımızı tutacak const tanımlayalım
                ...
                <div className="nav-item item-right">
                    <div className="navIcons">
                        <Link to="/notifications">
                            ...
                            <p className="display">Anasayfa</p>
                        </Link>
                    </div>
                    <div className="navIcons">
                        <Link to="/profile">
                    ...
                    {isAuthenticated ? (
                        <div className="navIcons">
                            ...
                            >
                                ...
                                <p className="display">Çıkış Yap</p>
                            </Link>
                        </div>
                    ) : (
                        <div className="navIcons">
                            <Link to="/signup">
                                ...
                                <p className="display">Kayıt Ol</p>
                            </Link>
                        </div>
                    )}
                </div>
